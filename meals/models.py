...
class MealFood(models.Model):
	...
	quantity = models.DecimalField(max_digits=8, decimal_places=2, help_text="Quantity in grams")
...
class DailySummary(models.Model):
	...
	weight_recorded = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True, help_text="Weight recorded for the day")
	created_at = models.DateTimeField(auto_now_add=True)
	updated_at = models.DateTimeField(auto_now=True)
