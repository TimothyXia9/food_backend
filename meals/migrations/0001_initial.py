    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weight_recorded', models.DecimalField(blank=True, decimal_places=2, help_text='Weight recorded for the day', max_digits=5, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['meal'], name='meals_mealf_meal_id_6bec07_idx')],
            },
        ),
        migrations.AddIndex(
            model_name='meal',
            index=models.Index(fields=['user', 'date'], name='meals_meal_user_id_9c94ad_idx'),
        ),
        migrations.AddIndex(
            model_name='meal',
            index=models.Index(fields=['user', 'meal_type'], name='meals_meal_user_id_b5db63_idx'),
        ),
        migrations.AddIndex(
            model_name='dailysummary',
            index=models.Index(fields=['user', 'date'], name='meals_daily_user_id_2342d4_idx'),
        ),
