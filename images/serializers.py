...
class UploadedImageSerializer(serializers.ModelSerializer):
	...
	class Meta:
		model = UploadedImage
		fields = [
			'id', 'filename', 'file_size', 'mime_type', 'width', 'height',
			'processing_status', 'uploaded_at', 'processed_at'
		]
		read_only_fields = ['id', 'file_size', 'mime_type', 'width', 'height', 'uploaded_at', 'processed_at']
...
class FoodRecognitionResultSerializer(serializers.ModelSerializer):
	...
	class Meta:
		...
		fields = [
			'id', 'food_name', 'confidence_score', 'estimated_quantity',
			'is_confirmed', 'food_calories_per_100g', 'food_protein_per_100g',
			'food_fat_per_100g', 'food_carbs_per_100g', 'created_at'
		]
...
class MealCreatedFromImageSerializer(serializers.Serializer):
	...
	foods_added = serializers.ListField(
