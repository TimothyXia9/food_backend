...
class UploadedImage(models.Model):
	...
	meal = models.ForeignKey('meals.Meal', on_delete=models.SET_NULL, null=True, blank=True, related_name='images')
...
class FoodRecognitionResult(models.Model):
	...
	image = models.ForeignKey(UploadedImage, on_delete=models.CASCADE, related_name='recognition_results')
	food = models.ForeignKey('foods.Food', on_delete=models.SET_NULL, null=True, blank=True)
	confidence_score = models.DecimalField(max_digits=5, decimal_places=4, help_text="Recognition confidence (0-1)")
	estimated_quantity = models.DecimalField(max_digits=8, decimal_places=2, null=True, blank=True, help_text="Estimated quantity in grams")
	is_confirmed = models.BooleanField(default=False, help_text="User confirmation status")
