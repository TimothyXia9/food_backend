...
class FoodAdmin(admin.ModelAdmin):
	"""食物管理界面"""
	list_display = ('name', 'brand', 'calories_per_100g', 'is_verified', 'created_by', 'created_at')
	...
	fieldsets = (
		...
		('营养信息 (每100g)', {
			'fields': ('calories_per_100g', 'protein_per_100g', 'fat_per_100g', 
...
class FoodSearchLogAdmin(admin.ModelAdmin):
	"""食物搜索日志管理界面"""
	list_display = ('search_query', 'user', 'search_type', 'results_count', 'created_at')
