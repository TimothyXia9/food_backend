...
# Email Configuration
# Use custom SES backend if AWS credentials are provided
if AWS_ACCESS_KEY_ID and AWS_SECRET_ACCESS_KEY:
    EMAIL_BACKEND = "accounts.ses_backend.SESEmailBackend"
else:
...
# Legacy email settings (kept for fallback)
EMAIL_HOST = config("EMAIL_HOST", default="smtp.gmail.com")
EMAIL_PORT = config("EMAIL_PORT", default=587, cast=int)
EMAIL_USE_TLS = config("EMAIL_USE_TLS", default=True, cast=bool)
EMAIL_HOST_USER = config("EMAIL_HOST_USER", default="")
EMAIL_HOST_PASSWORD = config("EMAIL_HOST_PASSWORD", default="")
DEFAULT_FROM_EMAIL = config("DEFAULT_FROM_EMAIL", default="noreply@calorietracker.com")

# Email verification settings
EMAIL_VERIFICATION_TOKEN_EXPIRE_HOURS = config(
    "EMAIL_VERIFICATION_TOKEN_EXPIRE_HOURS", default=24, cast=int
)
